...
public class RNTimePickerDialogFragment extends DialogFragment {
  ...
  static TimePickerDialog createDialog(
    ...
    if (args != null) {
      // for dialog buttons
      if (args.containsKey(RNConstants.ARG_CONFIRM_TEXT_ANDROID)) {
        dialog.setButton(TimePickerDialog.BUTTON_POSITIVE, args.getString(RNConstants.ARG_CONFIRM_TEXT_ANDROID), dialog);
      }
      if (args.containsKey(RNConstants.ARG_CANCEL_TEXT_ANDROID)) {
        dialog.setButton(TimePickerDialog.BUTTON_NEGATIVE, args.getString(RNConstants.ARG_CANCEL_TEXT_ANDROID), dialog);
      }
    }
